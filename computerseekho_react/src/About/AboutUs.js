    ...
    <div className="about-container">
      ...
      <table>
        <tr>
          ...
          <td style={{ textAlign: "right", marginRight: "20px" }}>
            <div>
              <img src='/images/img1.jpg' style={{ height: "300px" }} />
            </div>
          </td>
        </tr>
        <tr>
      ...
      <div className="course-section">
        ...
        <p align="justify">To develop capable users of information technology, who will effectively and creatively use the most amazing machine-a <b>PC!</b></p>
      </div>

      <div>
        <h3 style={{ textAlign: "center", marginTop: "20px" }}><b>Courses We Offer</b></h3>
        <div style={{ width: "98%", align: "center", margin: "2%" }}>
